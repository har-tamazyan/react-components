...
export const PromptNote = styled.p`
  ...
  padding-left: 12px;
`;
export const PromptNewLineNote = styled(PromptNote)`
  margin: 0;
`;

export const AddStatusPromptContentWrapper = styled.div`
  margin: 24px 24px 30px 24px;
`;

export const RemoveStatusPromptEmptyContent = styled.div`
  min-height: 48px;
`;

export const RemoveTeamMemberPromptContentWrapper = styled(AddStatusPromptContentWrapper)``;

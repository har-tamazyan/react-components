...
const OfferDetailsTemplate = ({
  ...
  const noOfPositions = job?.no_of_positions ?? 0;
  const {
    experience,
    company,
    location,
...
OfferDetailsTemplate.propTypes = {
...
export default connect(mapStateToProps)(OfferDetailsTemplate);

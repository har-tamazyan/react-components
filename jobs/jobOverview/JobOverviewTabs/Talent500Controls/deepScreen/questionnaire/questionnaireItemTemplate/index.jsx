...
import AddOptionIcon from 'src/web/ats/assets/icons/add-icon.svg';
import RemoveOptionIcon from 'src/web/ats/assets/icons/c-delete-large-grey.svg';
...
const QuestionnaireItem = ({
  ...
  const handleSaveQuestion = () => {
    ...
    saveEditedQuestion(currQuestionnaireItem, questionIndex);
    setIsWriteMode(false);
  };

  const renderOptions = () => {
    if (currQuestionnaireItem.question_type === QUESTION_TYPES_LIST_DATA.MCSA.type) {
      return <S.MCSAOptions>{currQuestionnaireItem.question_options.map((optionItem, index) => (
  ...
  return <S.QuestionWrapper key={currQuestionnaireItem.es_id || currQuestionnaireItem.id}>
    ...
    <S.OptionsWrapper>
      <S.OptionsHead isWriteMode={isWriteMode}>{isWriteMode
        ...
        {renderOptions()}
        {isWriteMode && <S.Actions>
          <S.SaveQuestion onClick={handleSaveQuestion}>Save</S.SaveQuestion>
        </S.Actions>}
    </S.OptionsWrapper>
  </S.QuestionWrapper>;
};
